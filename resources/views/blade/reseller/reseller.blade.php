...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper"
            style="background-color: #FFFFFF; font-family: 'Nexa', sans-serif;
        font-weight: 800;">
                ...
                <div class="container-fluid">
                    ...
                    font-weight: 800;">
                        <div class="row">
                            <div class="col-md-9">
                                @if (Session::has('val'))
                                    <a href="{{ route('session_clear', Session::has('val')) }}" class="ml-3 mt-3">
                            ...
                            <div class="col-md-3 text-right">
                                <span class="mt-3 text-dark">
                                    <img style="width: 25px" src="{{ asset('frontend/photo/coin.jpg') }}"
                                        alt="Coin Image">
                                    {{ $balance ?? '0' }}
                                </span>
                                <?php
                    ...
                    <section class="content">
                        ...
                        <div class="container mt-2">
                            ...
                            <div class="">
                                ...
                                <form action="{{ url('reseller_store') }}" method="post" style="margin-top: 100px">
                                    @csrf
